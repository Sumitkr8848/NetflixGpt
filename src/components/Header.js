    ...
    <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex flex-col md:flex-row justify-between">
      ...
      {user && (
        <div className="flex p-2 justify-between">
          {showGptSearch && (<select className='p-2 m-2 bg-gray-500 text-whit ' onChange={handleLanguageChange}>
          ...
          <img className="hidden md:block w-12 h-12" alt="icon" src={user?.photoURL} />
